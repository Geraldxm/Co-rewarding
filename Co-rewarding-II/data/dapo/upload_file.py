...
# === 配置区 ===
ORIGINAL_FILE = "coreward/data/dapo/train_original.parquet"
REWRITE_FILE  = "coreward/data/dapo/train_rewrite_Qwen3-32B.parquet"
OUTPUT_FILE   = "coreward/data/dapo/train_pairs.parquet"
